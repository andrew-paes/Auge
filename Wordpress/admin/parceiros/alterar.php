...
$pg_imagem = URLADMIN."parceiros/galeria.php?id=".$idP;
$msg_ok = "Dados Alterados";
$msg_erro = "Oops desculpe. Erro ao cadastrar!";
$nomeClasseG = "Parceiros";
...
if(isPost($_GET['removerItem'])){
    @unlink(PATHUPLOAD.'parceiros/'.$obj->arquivo);
    $_POST['item']['arquivo'] = "";
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="input-append">
                                    ...
                                    <a href="<?php echo URLUPLOAD.'parceiros/'.$_POST[$nomeClasse]['imagem']; ?>" class="lightBox btn btn-default active">Visualizar Imagem</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <?php
                            $editor = new CKEditor();
                            $editor->editor("descricao",$_POST[$nomeClasse]['descricao']);
                            ?>
                        </div>
                    </div>
                </div>
