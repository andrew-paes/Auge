            ...
            <footer class="panel-footer">
               <div class="row">
                   <div class="col-md-12 text-right">
                       <a href="javascript:void(0);" class="btn btnSalvarLegenda btn-primary modal-confirm" data-id-album="<?php echo $idP; ?>" data-indice="<?php echo $indiceTabela; ?>" data-nome-classe="<?php echo $nomeClasse; ?>" data-id="">Salvar</a>
