...
$titulo = "Usuários";
$acao = "Gerenciar";
$pg_cadastrar = URLADMIN."usuarios/cadastrar.php";
$pg_alterar = URLADMIN."usuarios/alterar.php";
$pg_visualizar = "";
...
<section role="main" class="content-body">
    ...
    <section class="panel">
        ...
        <div class="panel-body">            
            ...
            <?php
            if(isPost($_POST['txtBusca'])){
                $listar = UtilObjeto::listar($nomeTabela,"where id <> 1 and nome like '%".$_POST['txtBusca']."%' order by id desc");
            }else{
                $listar = UtilObjeto::listar($nomeTabela,"where id <> 1 order by id desc limit ".$Paginacao['limitini'].", ".$Paginacao['itensporpagina']);
            }
            if(is_array($listar)){
            ?>
