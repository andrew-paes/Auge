...
$titulo = "Newsletter";
$acao = "Gerenciar";
$pg_cadastrar = URLADMIN."newsletter/cadastrar.php";
$pg_alterar = URLADMIN."newsletter/alterar.php";
$pg_visualizar = URLADMIN."newsletter/visualizar.php";
$pg_exportar = URLADMIN."newsletter/exportar.php";
                ...
                <table class="table table-bordered table-hover table-striped table-condensed mb-none">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo mysql_to_data($dados['data'], true, true); ?></td>
