...
$pg_visualizar = URLADMIN."servicos/contato-visualizar.php";
$pg_exportar = URLADMIN."servicos/contato-exportar.php";
$msg_ok = "Registro Excluído!";
$msg_erro = "Erro ao excluir, verifique se existe tarefas vinculados a este usuário.";
$nomeClasse = "ServicosContato";
