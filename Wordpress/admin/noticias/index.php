...
$titulo = "Notícias";
$acao = "Gerenciar";
$pg_cadastrar = URLADMIN."noticias/cadastrar.php";
$pg_alterar = URLADMIN."noticias/alterar.php";
$pg_visualizar = "";
                ...
                <table class="table table-bordered table-hover table-striped table-condensed mb-none">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo mysql_to_data($dados['data']); ?></td>
